...
void MaterialCache1::init(GfxDevice& gfxDevice)
{
...
void MaterialCache1::cleanup(GfxDevice& gfxDevice)
{
    gfxDevice.destroyBuffer(materialDataBuffer);
}

MaterialId MaterialCache1::addMaterial(GfxDevice& gfxDevice, Material material)
{
...
const Material& MaterialCache1::getMaterial(MaterialId id) const
{
    return materials.at(id);
}

MaterialId MaterialCache1::getFreeMaterialId() const
{
    return materials.size();
}

MaterialId MaterialCache1::getPlaceholderMaterialId() const
{
    assert(placeholderMaterialId != NULL_MATERIAL_ID && "MaterialCache1::init not called");
